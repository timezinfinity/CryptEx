...
@Injectable()
export class BitfinexService implements OnDestroy, Exchange {

  public Type: string = "bitfinex";

  private apiUrlBase: string = 'https://api.bitfinex.com/v1';
  ...
  public setRefreshDelay(delay: number) {
    if (this.interval) {
      clearInterval(this.interval);
      this.interval = setInterval(this.getTickerDataRestfully.bind(this), delay);
    }
  }
